...
final List<MenuItem> classicItems = [
  ...
  const MenuItem(title: "Strawberry Colada",    imagePath: "assets/images/StrawberryColada.jpg",     price: 8.90),
  const MenuItem(title: "Touchdown",            imagePath: "assets/images/Touchdown.jpg",            price: 8.90),
  const MenuItem(title: "Tequila Sun Rises",    imagePath: "assets/images/TequilaSunRises.png",      price: 8.90),
  const MenuItem(title: "Cuba Libre",           imagePath: "assets/images/CubaLibre.png",            price: 8.90),
  const MenuItem(title: "Mojito",               imagePath: "assets/images/Mojito.jpg",               price: 8.90),
];
